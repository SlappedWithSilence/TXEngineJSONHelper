...
This project is a companion utility designed to expedite the process of generating content JSON files for the <a href = https://github.com/SlappedWithSilence/TXEngine>TXEngine</a>.
...
See the [open issues](https://github.com/SlappedWithSilence/TXEngineJSONHelper/issues) for a list of proposed features (and known issues).
...
Project Link: [TXEngineJSONHelper](https://github.com/SlappedWithSilence/TXEngineJSONHelper)
